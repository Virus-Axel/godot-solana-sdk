...
- **DD-5-4-5 (LOCKED) — addon consumption mechanism: tagged release.** External repo `godot-mwa-example` consumes `addons/SolanaSDK/` from this repo via GitHub Releases (published artifact ZIP), NOT via git submodule and NOT via vendor copy.
