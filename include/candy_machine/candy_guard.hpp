...
class MplCandyGuard : public Node {
	GDCLASS_CUSTOM(MplCandyGuard, Node)
private:
...
public:
	 ...
	 */
	static Variant new_limit_counter_pda(uint8_t mint_guard_id, const Variant &payer, const Variant &candy_machine_key, const Variant &candy_guard_key);
};
