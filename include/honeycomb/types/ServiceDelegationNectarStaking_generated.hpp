...
/**
 * @brief Resource wrapper for honeycomb type ServiceDelegationNectarStaking.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ServiceDelegationNectarStaking.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_SERVICEDELEGATIONNECTARSTAKING
