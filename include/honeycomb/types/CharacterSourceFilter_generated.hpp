...
/**
 * @brief Resource wrapper for honeycomb type CharacterSourceFilter.
 */
...
public:
	 ...
	 * @return Dictionary representation of this CharacterSourceFilter.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_CHARACTERSOURCEFILTER
