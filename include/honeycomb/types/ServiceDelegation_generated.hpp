...
/**
 * @brief Resource wrapper for honeycomb type ServiceDelegation.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ServiceDelegation.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_SERVICEDELEGATION
