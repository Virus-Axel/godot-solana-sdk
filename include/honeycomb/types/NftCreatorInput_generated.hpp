...
/**
 * @brief Resource wrapper for honeycomb type NftCreatorInput.
 */
...
public:
	 ...
	 * @return Dictionary representation of this NftCreatorInput.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_NFTCREATORINPUT
