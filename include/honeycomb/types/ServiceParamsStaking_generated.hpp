...
/**
 * @brief Resource wrapper for honeycomb type ServiceParamsStaking.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ServiceParamsStaking.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_SERVICEPARAMSSTAKING
