...
/**
 * @brief Resource wrapper for honeycomb type Multiplier.
 */
...
public:
	 ...
	 * @return Dictionary representation of this Multiplier.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_MULTIPLIER
