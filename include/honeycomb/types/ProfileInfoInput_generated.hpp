...
/**
 * @brief Resource wrapper for honeycomb type ProfileInfoInput.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ProfileInfoInput.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_PROFILEINFOINPUT
