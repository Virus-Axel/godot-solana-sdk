...
/**
 * @brief Resource wrapper for honeycomb type AssetCriteria.
 */
...
public:
	 ...
	 * @return Dictionary representation of this AssetCriteria.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_ASSETCRITERIA
