...
/**
 * @brief Resource wrapper for honeycomb type ResourceCustody.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ResourceCustody.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_RESOURCECUSTODY
