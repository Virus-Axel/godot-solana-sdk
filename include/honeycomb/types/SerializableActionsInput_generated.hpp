...
/**
 * @brief Resource wrapper for honeycomb type SerializableActionsInput.
 */
...
public:
	 ...
	 * @return Dictionary representation of this SerializableActionsInput.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_SERIALIZABLEACTIONSINPUT
