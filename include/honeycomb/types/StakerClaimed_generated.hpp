#ifndef GODOT_SOLANA_SDK_HONEYCOMB_TYPE_STAKERCLAIMED
#define GODOT_SOLANA_SDK_HONEYCOMB_TYPE_STAKERCLAIMED
...
/**
 * @brief Resource wrapper for honeycomb type StakerClaimed.
 */
class StakerClaimed : public Resource {
	GDCLASS(StakerClaimed, Resource)
...
public:
	 ...
	 * @return Dictionary representation of this StakerClaimed.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_STAKERCLAIMED
