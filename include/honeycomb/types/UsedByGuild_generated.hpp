...
/**
 * @brief Resource wrapper for honeycomb type UsedByGuild.
 */
...
public:
	 ...
	 * @return Dictionary representation of this UsedByGuild.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_USEDBYGUILD
