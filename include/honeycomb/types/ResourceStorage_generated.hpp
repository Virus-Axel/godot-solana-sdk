...
/**
 * @brief Resource wrapper for honeycomb type ResourceStorage.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ResourceStorage.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_RESOURCESTORAGE
