#ifndef GODOT_SOLANA_SDK_HONEYCOMB_TYPE_UPDATESPLSTAKINGPOOLMETADATAINPUT
#define GODOT_SOLANA_SDK_HONEYCOMB_TYPE_UPDATESPLSTAKINGPOOLMETADATAINPUT
...
/**
 * @brief Resource wrapper for honeycomb type UpdateSplStakingPoolMetadataInput.
 */
class UpdateSplStakingPoolMetadataInput : public Resource {
	GDCLASS(UpdateSplStakingPoolMetadataInput, Resource)
...
public:
	 ...
	 * @return Dictionary representation of this UpdateSplStakingPoolMetadataInput.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_UPDATESPLSTAKINGPOOLMETADATAINPUT
