#ifndef GODOT_SOLANA_SDK_HONEYCOMB_TYPE_TREESETUPRESPONSE
#define GODOT_SOLANA_SDK_HONEYCOMB_TYPE_TREESETUPRESPONSE
...
/**
 * @brief Resource wrapper for honeycomb type TreeSetupResponse.
 */
class TreeSetupResponse : public Resource {
	GDCLASS(TreeSetupResponse, Resource)
...
public:
	 ...
	 * @return Dictionary representation of this TreeSetupResponse.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_TREESETUPRESPONSE
