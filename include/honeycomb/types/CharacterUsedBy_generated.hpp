...
/**
 * @brief Resource wrapper for honeycomb type CharacterUsedBy.
 */
...
public:
	 ...
	 * @return Dictionary representation of this CharacterUsedBy.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_CHARACTERUSEDBY
