...
/**
 * @brief Resource wrapper for honeycomb type UpdateBadgeCriteriaInput.
 */
...
public:
	 ...
	 * @return Dictionary representation of this UpdateBadgeCriteriaInput.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_UPDATEBADGECRITERIAINPUT
