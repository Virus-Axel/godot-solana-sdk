...
/**
 * @brief Resource wrapper for honeycomb type TimeRequirement.
 */
...
public:
	 ...
	 * @return Dictionary representation of this TimeRequirement.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_TIMEREQUIREMENT
