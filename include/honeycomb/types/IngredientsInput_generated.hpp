...
/**
 * @brief Resource wrapper for honeycomb type IngredientsInput.
 */
...
public:
	 ...
	 * @return Dictionary representation of this IngredientsInput.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_INGREDIENTSINPUT
