...
/**
 * @brief Resource wrapper for honeycomb type GuildRoleFilter.
 */
...
public:
	 ...
	 * @return Dictionary representation of this GuildRoleFilter.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_GUILDROLEFILTER
