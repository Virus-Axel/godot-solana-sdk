...
/**
 * @brief Resource wrapper for honeycomb type CharacterSource.
 */
...
public:
	 ...
	 * @return Dictionary representation of this CharacterSource.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_CHARACTERSOURCE
