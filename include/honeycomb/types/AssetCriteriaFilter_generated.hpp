...
/**
 * @brief Resource wrapper for honeycomb type AssetCriteriaFilter.
 */
...
public:
	 ...
	 * @return Dictionary representation of this AssetCriteriaFilter.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_ASSETCRITERIAFILTER
