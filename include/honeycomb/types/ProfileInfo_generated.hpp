...
/**
 * @brief Resource wrapper for honeycomb type ProfileInfo.
 */
...
public:
	 ...
	 * @return Dictionary representation of this ProfileInfo.
	 */
	Dictionary to_dict();
...
#endif // GODOT_SOLANA_SDK_HONEYCOMB_TYPE_PROFILEINFO
