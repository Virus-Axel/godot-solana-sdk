#define HONEYCOMB_METHOD_DEFS 	Variant createCreateNewResourceTransaction(const Variant& project, const Variant& authority, Variant params, String delegateAuthority = "", String payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	...
	Variant createInitializeRecipeTransaction(const Variant& project, int64_t xp, Array ingredients, Variant meal, const Variant& authority, const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createAddIngredientsTransaction(const Variant& recipe, Array ingredients, const Variant& authority, const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createRemoveIngredientsTransaction(const Variant& recipe, PackedStringArray ingredients, const Variant& authority, const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createInitCookingProcessTransactions(const Variant& recipe, const Variant& authority, const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	...
	Variant createUpdateMissionTransaction(const Variant& missionAddress, const Variant& authority, Variant params, const Variant& payer = "", const Variant& delegateAuthority = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	...
	Variant createCreateStakingPoolTransaction(const Variant& project, const Variant& resource, Variant metadata, const Variant& authority, Variant multiplier = Variant(nullptr), const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createUpdateStakingPoolTransaction(const Variant& project, const Variant& stakingPool, const Variant& authority, Variant metadata = Variant(nullptr), const Variant& characterModel = "", const Variant& resource = "", const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createInitMultipliersTransaction(const Variant& project, const Variant& stakingPool, int32_t decimals, Array multipliers, const Variant& authority, const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createAddMultiplierTransaction(const Variant& project, const Variant& multiplier, Variant metadata, const Variant& authority, const Variant& delegateAuthority = "", const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createStakeCharactersTransactions(PackedStringArray characterAddresses, const Variant& project, const Variant& characterModel, const Variant& stakingPool, const Variant& feePayer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createClaimStakingRewardsTransactions(PackedStringArray characterAddresses, const Variant& characterModel, const Variant& feePayer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createUnstakeCharactersTransactions(PackedStringArray characterAddresses, const Variant& characterModel, const Variant& feePayer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createAddCharacterTraitsTransactions(const Variant& assemblerConfig, Array traits, const Variant& authority, const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createRemoveCharacterTraitsTransactions(const Variant& assemblerConfig, PackedStringArray traitsAddresses, const Variant& authority, const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createCreateCharacterModelTransaction(Variant config, const Variant& project, const Variant& authority, Array attributes = Array(), const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	Variant createCreateCharactersTreeTransaction(Variant treeConfig, const Variant& project, const Variant& characterModel, const Variant& authority, const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
	...
	Variant createPopulateAssembleablCharacterTransaction(Array attributes, const Variant& project, const Variant& characterModel, const Variant& charactersTree, const Variant& mint, const Variant& owner, const Variant& updateAuthority, const Variant& payer = "", PackedStringArray lutAddresses = PackedStringArray(), int32_t computeUnitPrice = -1);\
