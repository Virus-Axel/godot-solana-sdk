...
void HoneyComb::_bind_methods(){
	...
	ClassDB::bind_method(D_METHOD("signWithShadowSignerAndSendTransactionBundles", "txs", "blockhash", "lastValidBlockHeight", "authToken", "options"), &HoneyComb::signWithShadowSignerAndSendTransactionBundles, DEFVAL(Variant(nullptr)));
