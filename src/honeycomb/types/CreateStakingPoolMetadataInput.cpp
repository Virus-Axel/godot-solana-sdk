...
String CreateStakingPoolMetadataInput::get_name() const {
return this->name;
}
...
int64_t CreateStakingPoolMetadataInput::get_rewardsPerDuration() const {
...
int64_t CreateStakingPoolMetadataInput::get_rewardsDuration() const {
...
int64_t CreateStakingPoolMetadataInput::get_maxRewardsDuration() const {
...
int64_t CreateStakingPoolMetadataInput::get_minStakeDuration() const {
...
int64_t CreateStakingPoolMetadataInput::get_cooldownDuration() const {
...
bool CreateStakingPoolMetadataInput::get_resetStakeDuration() const {
...
int64_t CreateStakingPoolMetadataInput::get_startTime() const {
return this->startTime;
}

void CreateStakingPoolMetadataInput::set_lockType(const String& val) {
    this->lockType = val;
}

String CreateStakingPoolMetadataInput::get_lockType() const {
...
int64_t CreateStakingPoolMetadataInput::get_endTime() const {
return this->endTime;
}
...
ClassDB::add_property("CreateStakingPoolMetadataInput", PropertyInfo(Variant::STRING, "lockType"), "set_lockType", "get_lockType");
...
ClassDB::bind_method(D_METHOD("to_dict"), &CreateStakingPoolMetadataInput::to_dict);
}
