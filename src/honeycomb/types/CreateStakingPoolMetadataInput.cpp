...
void CreateStakingPoolMetadataInput::from_dict(const Dictionary& dict){
name = dict["name"];
...
ClassDB::bind_method(D_METHOD("from_dict", "dict"), &CreateStakingPoolMetadataInput::from_dict);
}
} // honeycomb_resource
} // godot