...
void ClaimBadgeCriteriaInput::set_proof(const Variant& val){
this->proof = val;
}

Variant& ClaimBadgeCriteriaInput::get_proof(){
return this->proof;
}
...
res["profileAddress"] = Object::cast_to<godot::honeycomb_resource::Pubkey>(profileAddress)->to_dict();
res["payer"] = Object::cast_to<godot::honeycomb_resource::Pubkey>(payer)->to_dict();
res["criteriaIndex"] = criteriaIndex;
res["proof"] = Object::cast_to<godot::honeycomb_resource::BadgesCondition>(proof)->to_dict();
return res;
}
...
ClassDB::add_property("ClaimBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "projectAddress"), "set_projectAddress", "get_projectAddress");
...
ClassDB::add_property("ClaimBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "profileAddress"), "set_profileAddress", "get_profileAddress");
...
ClassDB::add_property("ClaimBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "payer"), "set_payer", "get_payer");
...
ClassDB::add_property("ClaimBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "proof"), "set_proof", "get_proof");
}
} // honeycomb_resource
} // godot