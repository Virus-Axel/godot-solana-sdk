...
void UpdateBadgeCriteriaInput::set_condition(const Variant& val){
this->condition = val;
}

Variant& UpdateBadgeCriteriaInput::get_condition(){
...
ClassDB::add_property("UpdateBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "projectAddress"), "set_projectAddress", "get_projectAddress");
...
ClassDB::add_property("UpdateBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "authority"), "set_authority", "get_authority");
...
ClassDB::add_property("UpdateBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "payer"), "set_payer", "get_payer");
...
ClassDB::add_property("UpdateBadgeCriteriaInput", PropertyInfo(Variant::Type::VARIANT, "condition"), "set_condition", "get_condition");
}
} // honeycomb_resource
} // godot