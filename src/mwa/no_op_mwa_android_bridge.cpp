...
void NoOpMwaAndroidBridge::emit_unsupported(const godot::String &source_method,
	...
	if (dispatcher_ == nullptr) {
		return;
	} // defensive; should have failed at ctor.
	...
	payload["developer_details"] =
			godot::String("Non-Android build: MwaAndroidBridge::create() returned NoOpMwaAndroidBridge on platform=") + os_name + godot::String(".");
