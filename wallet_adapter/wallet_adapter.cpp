...
String WalletAdapter::wallet_name_from_type(WalletType wallet_type) const {
...
String WalletAdapter::wallet_check_name_from_type(WalletType wallet_type) const {
	if (wallet_type >= WalletType::MAX_TYPES) {
		return "";
	}
...
PackedByteArray WalletAdapter::get_message_signature() const {
...
Array WalletAdapter::get_available_wallets() const {
