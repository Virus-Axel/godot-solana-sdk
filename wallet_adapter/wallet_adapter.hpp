...
private:
	...
	String wallet_name_from_type(WalletType wallet_type) const;
	String wallet_check_name_from_type(WalletType wallet_type) const;
...
public:
	...
	PackedByteArray get_message_signature() const;

	Array get_available_wallets() const;
